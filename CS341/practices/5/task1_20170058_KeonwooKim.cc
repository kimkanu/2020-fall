...
void experiment (bool enableCtsRts, std::string wifiManager, double xCoord)
{
  ...
  posAllocator.Add (Vector (xCoord, 0, 0));
...
int main (int argc, char **argv)
{
  ...
  for (int xCoord = 10; xCoord <= 80; xCoord += 5) {
    std::cout << "xCoord: " << xCoord << std::endl;
    experiment (false, wifiManager, (double)xCoord);
  }
